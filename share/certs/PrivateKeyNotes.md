...
unlocked to sign the Kimdotcoin-Qt.app bundle.
...
allowing somebody to distribute a Kimdotcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the kimdotcoin-qt.exe file inside the installer had not been tampered with.
